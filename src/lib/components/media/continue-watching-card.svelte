...
<ContextMenu.Root>
  <ContextMenu.Trigger class="contents">
    ...
    >
      <div
        class="absolute inset-0 bg-linear-to-br from-muted via-muted to-background"
      ></div>
      ...
      <div
        class="pointer-events-none absolute inset-x-0 bottom-0 flex flex-col gap-2 p-3"
      >
        <div class="min-w-0">
