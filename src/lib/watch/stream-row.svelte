...
<button
  ...
  {disabled}
  {onclick}
  class="group/row flex min-w-0 flex-1 items-start gap-3 rounded-xl border border-foreground/10 bg-foreground/5 p-2.5 text-left transition-all enabled:hover:border-primary/40 enabled:hover:bg-foreground/10 disabled:opacity-50"
>
  <span
